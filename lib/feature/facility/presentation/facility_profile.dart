...
class FacilityProfile extends StatefulWidget {
  FacilityProfile({Key key}) : super(key: key);

  @override
  _FacilityProfileState createState() => _FacilityProfileState();
}
                              ...
                              children: [
                                Container(
                                  child: Column(children: [
                                    Container(
                                      child: Text("BluePearl Pet Hospital"),
                                    )
                                  ],),
                                )
                              ],
                      ...
                      children: [
                        Container(
                          ...
                          child: Material(
                            ...
                            borderRadius: BorderRadius.circular(5),
                            child: Container(
                               margin: EdgeInsets.only(left: wp(4), right: wp(4), top:hp(3)),
                              child: Column(
                                children: [
                                  Container(
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          child:Row(
                                            children: [
                                              Icon(Icons.star, color: AppColor.duty_doctorYellow, size:15),
                                              Icon(Icons.star, color: AppColor.duty_doctorYellow, size:15),
                                              Icon(Icons.star, color: AppColor.duty_doctorYellow, size:15),
                                              Icon(Icons.star, color: AppColor.duty_doctorYellow, size:15),
                                              Icon(Icons.star, color: AppColor.duty_doctorYellow, size:15)
                                  ...
                                  Container(
                                    ...
                                    child:RichText(text: TextSpan(text: 'I am very active and with that has come my share of mishaps. Dr Marget explains exactly what is wrong and how we are going to repair. I sincerely trust…',
