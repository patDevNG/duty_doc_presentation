...
class PersonalizedService extends StatefulWidget {
  PersonalizedService({Key key}) : super(key: key);

  @override
  _PersonalizedServiceState createState() => _PersonalizedServiceState();
}

class _PersonalizedServiceState extends State<PersonalizedService> {
  String  practitioner;
  @override
